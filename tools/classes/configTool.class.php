...
// this function required by the main program
 ...
 * @package 	OWAB
 *
 * Modified 02/2007 by Craig Dietrich to include security enhancements
 *
 */
/**
 * ConfigTool
	...
	*/	
	...
	{ 
	   if( file_exists( $this->FILENAME ) )
	   {
		...
		// The following added by CD:
		// the "#<?\n" iscritical to rid access to the config file via http ...
		if (substr($pContent, 0, 3) != "#<?") $pContent = "#<?\n".$pContent;
