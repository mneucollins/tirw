...
<table id="tableFront" cellspacing="0" cellpadding="0">
	<tr>
		<td class="columnTitleLeft">
			<h1>
				<big>TIR-W Volume 9 no. 2</big>
				<br />
				<big>Instruments and Playable Text</big>
			</h1>
			<h1>
				<br />Stuart Moulthrop, Guest Editor
			</h1>
		</td>
		<td class="columnTitleRight" style="vertical-align:middle;">
			<input type="button" value="Enter The Issue!" onclick="document.location.href='judymalloy.php';" />
		</td>
		<td>
			&nbsp;
		</td>
	...
	<tr>
		<td class="columnLeft">
			...
			<p align="left">
				The genealogy of <i>instruments and playable texts</i>, considered as a literary (or essential fictional) micro-movement, is best understood in terms of transition, or a series of transits.
			</p>
			<p align="left">
				<strong>Transit 1: De Paris &agrave; Liberty City en quatre.</strong>
			</p>
			<p align="left">
				First of course came <i>litt&eacute;rature potentielle</i>, that great investigation of possibility not just in writing, but in the act of writing: and with it, the notion that literary texts might be held open not just in theory but in transmission, reception, and most novel of all, <i>operation</i>.  It needs then just a quick hop over channel or ocean to ferry us from Georges Perec or Harry Mathews to John Cayley and Michael Joyce, from new structures for literature to various kinds of writing-forward: say "programmatology," or "a structure for what does not yet exist."
			</p>
			<p align="left">
				So, having anagrammatized LI-PO into its germinal <i>mode d'emPLOI</i>, we translate ourselves into the Anglo-Russian idiom, and its great pastime, word golf.  What is this fascination with flickering, digital signifiers, but a PLOY on the part of certain literary vagabonds, the likes of Judy Malloy, Deena Larsen, Shelley Jackson, or Jane Douglas, to mix it up across the Two Cultures, con-fusing the domains of computation and writing?  And what would be the aim of all this tricksterei, clearly on evidence at sites like <i>Grand Text Auto</i>, but to open the doors of the library and make it once again a place of PLAY?
			</p>
			<p align="left">
				<strong>Transit 2: From Diotallevi to Wikipedia</strong>
			</p>
			<p align="left">
				Surprisingly, just as there may actually be one American not deeply fanatical about baseball (that would be me), there are also writers, even great ones, who seem to dislike word golf.  That would be the Eco of <i>Foucault's Pendulum</i>, or the particular projection or Ecologue who makes his character Diotallevi say this:
			</p>
			<p align="left" class="in1">
				My cells have learned that you can blaspheme by anagrammatizing the Book, and all the books of the world.  And they have learned to do this now with my body.  They invert, transpose, alternate, transform themselves into cells unheard of, new cells without meaning, or with meaning contrary to the right meaning.  There must be a right meaning and a wrong meaning: otherwise you die.  My cells joke, without faith, blindly. (566)</p>
			<p align="left">
				I recall hearing these words, taken rather loosely from their complex, fictive context, quoted at a meeting of the <i>soi-disant</i> Modern Language Association, in a passionate complaint against electronic writing.  This was long ago, in another century.  <i>Modo</i> is of course an inherently moving target, and what was <i>&agrave; la mode</i> before the Millennium may now appear ponderously (if not pedantically) antique.  Still, it is worth remembering that some people once keenly feared what might happen if, as I like to say, the word will not be still.  Dire things would follow, we were told.  The end of learning, the decline of the west, foreclosure of the American mind.  Pain.  Death.  Cancer.
			</p>
			<p align="left">
				These last three are indeed not joking matters, as at least one of them must come to you and me.  You do not have to share my family history of acute Puritanism to feel exposed to the brimstone preacher's agenbite: <i>hey you with the goofy grin, leave off  that sinful foolery -- don't you know you're going to die?</i>
			...
			<p align="left" class = "in1">
				<i>Foucault's Pendulum</i> (original title: <i>Il pendolo di Foucault</i>) is a <a href="https://en.wikipedia.org/wiki/Novel" target="_blank">novel</a> by <a href="https://en.wikipedia.org/wiki/Italy" target="_blank">Italian</a> <a href="https://en.wikipedia.org/wiki/Novelist" target="_blank">novelist</a> and <a href="https://en.wikipedia.org/wiki/Philosopher" target="_blank">philosopher</a> <a href="https://en.wikipedia.org/wiki/Umberto_Eco" target="_blank">Umberto Eco</a>. It was first published in <a href="https://en.wikipedia.org/wiki/1988" target="_blank">1988</a>; the translation into English by <a href="https://en.wikipedia.org/wiki/William_Weaver" target="_blank">William Weaver</a> appeared a year later.
			</p>
			<p align="left" class = "in1">
				<i>Foucault's Pendulum</i> is divided into ten segments represented by the ten <a href="https://en.wikipedia.org/wiki/Sephirot_(Kabbalah)" target="_blank">Sefiroth</a>. The novel is full of <a href="https://en.wikipedia.org/wiki/Esoteric" target="_blank">esoteric</a> references to the <a href="https://en.wikipedia.org/wiki/Kabbalah" target="_blank">Kabbalah</a>, <a href="https://en.wikipedia.org/wiki/Alchemy" target="_blank">alchemy</a> and <a href="https://en.wikipedia.org/wiki/Conspiracy_theory" target="_blank">conspiracy theory</a>, so many that critic and novelist <a href="https://en.wikipedia.org/wiki/Anthony_Burgess" target="_blank">Anthony Burgess</a> has suggested that it needed an index. The title of the book derives from an <a href="https://en.wikipedia.org/wiki/Foucault_pendulum" target="_blank">actual pendulum</a> designed by the French physicist <a href="https://en.wikipedia.org/wiki/Le%CC%81on_Foucault" target="_blank">L&eacute;on Foucault</a> to demonstrate the rotation of the earth.
				(Wikipedia)
			</p>
			<p align="left">
			...
			<p align="left">
				"Programmatology."  See Brian Kim Stefans' interview with John Cayley at <a href="http://www.uiowa.edu/~iareview/tirweb/feature/cayley/index.html" target="_blank">http://www.uiowa.edu/~iareview/tirweb/feature/cayley/index.html</a>.
			</p>
			<p align="left">
				"A structure for what does not yet exist."  See Michael Joyce, "Siren Shapes: Exploratory and Constructive Hypertexts."  In N. Wardrip-Fruin and N. Montfort, eds., <i>The New Media Reader.</i>  MIT Press, 2003.  613-24.
			</p>
			<p align="left">
				Diotallevi's lament.  See Umberto Eco, <i>Foucault's Pendulum.</i>  Trans. William Weaver.  New York: Harcourt, Brace, Jovanovich, 1989.
			</p>
			<p align="left">
				"He saw that infinite complexity..."  From Jonathan Coulton, "Mandelbrot Set."  See <a href="http://www.jonathancoulton.com" target="_blank">www.jonathancoulton.com</a>.
			</p>
			<p align="left">
				Wikipedia.  See <a href="https://en.wikipedia.org/wiki/Foucault's_Pendulum" target="_blank">https://en.wikipedia.org/wiki/Foucault's_Pendulum</a>.
			</p>
			<p align="left">
			</p>
...
TIR-W is sponsored by The University of Iowa Graduate College, and is a project of housed in the <a href="http://research-intermedia.art.uiowa.edu/wing/" target="_blank">Virtual Writing University Experimental Wing</a>.
			</p>
			<p>
...
Writers and artists interested in having your work considered are encouraged to send a query email. Please include relevant autobiographical information and a brief description of your work in general; information about the work you would like to submit to TIR-W, including, when appropriate, the URL of the work.
			...
			<strong>A note from the managing editor</strong>
			</p>
			<p>
...
<!--
 ...
 -->
				...
				<br />
<script language="JavaScript" type="text/javascript">document.write("Cr");document.write("aig"+"&nbsp;Diet");document.write("ri");document.write("c"+"h");</script>, Technology Development Consultant
				<br />
				Aaron Brandt, Design Contributor
			</p>
			<p>
				<strong>
					Contact TIR-W</strong>
				<br />
Jon Winet<br />
jon-winet@uiowa.edu <br /><br />
Mark NeuCollins<br />
